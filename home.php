			...
			<div class="modal-content ">
				<div class="modal-body">
					...
					<div class="post-user-details clearfix">
						<img src="assets/media/img/pp_photo/Abiruzzaman Abir.jpg" alt="">
						<div class="post-user-info-details">
							<h4>Abiruzzaman Abir</h4>
							...
							<div class="card shadow-sm">
								<div class="card-body">
									...
									<div class="post-header clearfix">
										<img src="<?php echo $post['dp'] ?>" alt="">
										<div class="post-user-info">
											<h4><a href="#"><?php echo $post['name'] ?></a></h4>
											<p><?php echo $post['time'] ?> mins <i class="fas fa-globe-americas"></i></p>
										</div>
									...
									<div class="post-likes clearfix">
										<div class="like float-left">
											<img src="assets/media/img/post/like.svg" alt=""> <?php echo $post['like'] ?>
										</div>
										<div class="comment float-right">
										<?php echo $post['comment'] ?> comments 
										</div>
									</div>
									<hr>
